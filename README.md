...
<img width="589" height="323" alt="Screenshot 2025-05-03 165119" src="https://github.com/user-attachments/assets/362dd740-be74-4de2-8382-f0ebac9b5921" />

## INSIGHTS
+ ### Medical Issues Are the Leading Cause of Absenteeism  
   - #### Medical reasons account for a significant majority (555 cases) of absences, far exceeding all other categories. This points to a pressing need for workplace wellness programs and better healthcare support.

+ ### Absenteeism Peaks in Spring and Early Months of the Year  
   - #### Spring recorded the highest seasonal absenteeism (195 cases), while March and February had the highest monthly absenteeism counts. This pattern may align with seasonal illnesses or workload pressure at the beginning of the year.

+ ### High Workload May Contribute to Absenteeism and Stress  
   - #### With a maximum average workload of 378.9 tasks/day, there’s a potential link between workload and employee health issues, especially medical-related absences and stress-related BMI changes.

+ ### Health Risks Exist Despite Normal BMI Majority  
   - #### Although 40.5% of employees have a normal BMI, a combined 59.5% are either overweight or obese, suggesting potential long-term health risks that could increase absenteeism if not addressed through wellness initiatives.
 
## RECOMMENDATIONS
+ ### Implement a Workplace Wellness Program  
   - #### Introduce health screenings, mental health support, and regular fitness activities to address the high rate of medical-related absenteeism and improve overall employee well-being.

+ ### Adjust Workload Distribution  
   - #### Review and redistribute tasks to reduce the high average workload (378.9/day). This could help prevent burnout, reduce stress-related health issues, and improve productivity.

+ ### Monitor and Support Seasonal Health Trends  
   - #### Since Spring and early-year months show peak absenteeism, proactively provide health resources (e.g. flu shots, wellness tips) and allow for flexible scheduling during these high-risk periods.

+ ### Promote Healthy Lifestyle Education  
   - #### With a significant number of employees classified as overweight or obese, offer nutrition and fitness guidance, incentives for healthy habits, and possibly partner with health professionals for workshops.
